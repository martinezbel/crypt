...
html_temp = """
		...
		<h1 style="color:{};text-align:center;">Crypto Price App </h1>
		</div>
		"""
st.markdown(html_temp.format('green', 'white'), unsafe_allow_html=True)
st.text("")
...
* **Created by:**  Oscar Martinez (Python, Machine Learning, AI, DevOps)
